...
export function AirlineList({ routes, onEdit, onDelete, hasVoiceGuide }) {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {routes.map((route) => {
          ...
          const routeHasBackgroundMusic =
            route.cloudStorageId && route.cloudStorageId.trim() !== '';
          return (
            <Card
              key={route._id}
              className="bg-card border border-border shadow-sm hover:shadow-md hover:border-primary transition-all duration-200"
            >
              <CardContent className="p-5 flex flex-col h-full">
                ...
                <div className="mt-auto pt-4 border-t border-border flex gap-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="h-9 px-3 text-destructive border-destructive/50 hover:bg-destructive/10 hover:border-destructive"
                  >
