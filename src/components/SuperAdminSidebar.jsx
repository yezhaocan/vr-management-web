  ...
  return (
    <div className="w-64 bg-card border-r border-border flex flex-col h-full">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 text-xs font-light">
              Virtual Reality Tourism Platform
            </p>
          </div>
        </div>
      </div>
        ...
        {menuItems.map((item) => {
          ...
          return (
            <Button
              ...
              className={`w-full justify-start text-left ${isActive ? '' : 'text-muted-foreground hover:bg-accent hover:text-accent-foreground'}`}
      ...
      <div className="p-4 border-t border-border bg-background">
        <Button
          variant="ghost"
          className="w-full justify-start text-left text-muted-foreground hover:bg-accent hover:text-accent-foreground"
          onClick={onLogout}
        >
