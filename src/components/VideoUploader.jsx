...
export function VideoUploader({ onUpload, loading }) {
  ...
  return (
    <Card className="bg-gray-800/50 border-gray-700">
      <CardHeader>
        ...
        <CardDescription className="text-gray-400">上传飞行录像文件</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="请输入录像描述..."
            className="w-full h-16 bg-gray-800 border border-gray-600 rounded-lg p-2 text-white text-sm"
          />
        </div>
